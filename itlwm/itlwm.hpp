...
public:
	...
	virtual void associate(uint8_t *ssid, uint32_t ssid_len, uint32_t authtype_lower, uint32_t authtype_upper, uint8_t *key, uint32_t key_len, int key_index) override;
#endif
};
